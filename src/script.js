function addCityTime(event) {
  ...
  if (event.target.value === "bangkok") {
    ...
    selectedTime.innerHTML = moment.tz("Asia/Bangkok").format("HH:mm:ss");
  }
  if (event.target.value === "reykjavik") {
    ...
    selectedDate.innerHTML = moment
      ...
      .format("Do MMMM YYYY");
    selectedTime.innerHTML = moment.tz("Atlantic/Reykjavik").format("HH:mm:ss");
  }
  if (event.target.value === "copenhagen") {
    ...
    selectedDate.innerHTML = moment
      ...
      .format("Do MMMM YYYY");
    selectedTime.innerHTML = moment.tz("Europe/Copenhagen").format("HH:mm:ss");
  }
  if (event.target.value === "local-time") {
    selectedCity.innerHTML = localTimezone;
    selectedTime.innerHTML = moment().format("HH:mm:ss");
